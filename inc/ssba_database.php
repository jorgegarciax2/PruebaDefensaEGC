...
function ssba_activate() {
    ...
    $ssba_settings = array(
        ...
        //CODIGO IMPLEMENTADO POR JORGARGAR2 PARA ESTABLECER EL VALOR DE ACTIVACIÓN POR DEFECTO DE LOS BOTONES DE FOLLOW
        'ssba_twitter_follow' => 'Y',
        'ssba_facebook_follow' => 'Y',

        //CODIGO IMPLEMENTADO POR JORGARGAR2 PARA ESTABLECER EL USUARIO POR DEFECTO DE LOS BOTONES DE FOLLOW
        'ssba_twitter_follow_user' => "congresosplcus",
        'ssba_facebook_follow_user' => "Splc-2017-1485599238204174",
        
         //CODIGO IMPLEMENTADO POR EUSGARPLA PARA ESTABLECER EL VALOR DE ACTIVACIÓN POR DEFECTO DE LOS BOTONES DE FOLLOW
        'ssba_twitter_feed' => '',
        'ssba_facebook_feed' => '',

        //CODIGO IMPLEMENTADO POR EUSGARPLA PARA ESTABLECER EL USUARIO POR DEFECTO DE LOS BOTONES DE FOLLOW
        'ssba_twitter_feed_hashtag' => "congresosplcus",
        'ssba_facebook_page_name' => "Splc-2017-1485599238204174"
...
function ssba_delete_old_options()
{
    ...
    //CODIGO IMPLEMENTADO POR JORGARGAR2 PARA PERMITIR DESMARCAR LAS OPCIONES DE ACTIVACION DE LOS BOTONES DE FOLLOW
    delete_option('ssba_twitter_follow');
    delete_option('ssba_facebook_follow');
    delete_option('ssba_twitter_follow_user');
    delete_option('ssba_facebook_follow_user');

    //CODIGO IMPLEMENTADO POR EUSGARPLA
	delete_option('ssba_twitter_feed');
	delete_option('ssba_facebook_feed');
	delete_option('ssba_twitter_hashtag');
	delete_option('ssba_facebook_page_name');
}
