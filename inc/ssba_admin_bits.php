...
function ssba_settings() {
	...
	if(isset($_POST['ssbaData']))
	{
        ...
        $arrOptions = array(
			...
			//CODIGO IMPLEMENTADO POR JORGARGAR2 PARA PERMITIR QUE FUNCIONE LA OPCION DE ACTIVAR Y DESACTIVAR LOS BOTONES DE FOLLOW
			'ssba_twitter_follow' => (isset($ssbaPost['ssba_twitter_follow']) ? $ssbaPost['ssba_twitter_follow'] : NULL),
			'ssba_facebook_follow' => (isset($ssbaPost['ssba_facebook_follow']) ? $ssbaPost['ssba_facebook_follow'] : NULL),

			//CODIGO IMPLEMENTADO POR JORGARGAR2 PARA PERMITIR QUE FUNCIONE EL CAMPO DE MODIFICACION DEL USUARIO
			'ssba_twitter_follow_user' => stripslashes_deep($ssbaPost['ssba_twitter_follow_user']),
    		'ssba_facebook_follow_user' => stripslashes_deep($ssbaPost['ssba_facebook_follow_user']),

			//CODIGO IMPLEMENTADO POR EUSGARPLA PARA PERMITIR QUE FUNCIONE LA OPCION DE ACTIVAR Y DESACTIVAR LOS BOTONES DE FOLLOW
			'ssba_twitter_feed' => (isset($ssbaPost['ssba_twitter_feed']) ? $ssbaPost['ssba_twitter_feed'] : NULL),
			'ssba_facebook_feed' => (isset($ssbaPost['ssba_facebook_feed']) ? $ssbaPost['ssba_facebook_feed'] : NULL),

			//CODIGO IMPLEMENTADO POR EUSGARPLA PARA PERMITIR QUE FUNCIONE EL CAMPO DE MODIFICACION DEL USUARIO
			'ssba_twitter_feed_hashtag' => (isset($ssbaPost['ssba_twitter_feed_hashtag']) ? $ssbaPost['ssba_twitter_feed_hashtag'] : NULL),
    		'ssba_facebook_page_name' => (isset($ssbaPost['ssba_facebook_page_name']) ? $ssbaPost['ssba_facebook_page_name'] : NULL),
